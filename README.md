...
To fully assemble this board, you will need:
* **1x** BW16 (RTL8720DN) Module
* **1x** 0.96" OLED Screen (I2C)
* **4x** Through-hole 6x6mm Tactile Buttons
...
* **Made for Nova-X:** Fully compatible layout designed specifically around the Nova-X firmware.
* **Dual-Band Hardware:** Utilizes the BW16 module for 2.4GHz and 5GHz network analysis and deauth testing.
* **Open & Free:** All Gerber files are open-source and ready to send straight to manufacturers like JLCPCB or PCBWay.

---

### 🛠️ Getting Started

1. **Download:** Grab the Gerber zip file from this repository.
2. **Order:** Upload the zip to your preferred PCB manufacturer.
3. **Build:** Solder the listed components, flash the **Nova-X firmware** onto the BW16, and you're good to go!
